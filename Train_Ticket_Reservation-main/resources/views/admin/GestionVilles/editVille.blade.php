...
<form action="{{route('GestionVilles.update', [ 'GestionVille' => $ville->id])}}" method="post" class="formm">
   @csrf
   @method('PUT')
               ...
               <div>
                ...
                <div class="col-12">
                  <fieldset class="form-group">
                    <label class="form-label" for="input4">Nom de ville</label>
                    <input type="text" class="form-control" name="nomVille" id="nomVille" placeholder="nombre de Places" value="{{old('nomVille',$ville->nomVille)}}">
                 </fieldset>
                </div>
